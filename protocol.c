...
enet_protocol_handle_incoming_commands (ENetHost * host, ENetEvent * event)
{
    ...
    /*Change due to upping max connections!!!*/
    if (peerID == 0xfff)
    {
...
{
    enet_uint8 headerData [sizeof (ENetProtocolHeader) + sizeof (enet_uint16) + sizeof (enet_uint32)]; // changed this line to upp max connections
         ...
         ++ currentPeer)
    {
        ...
        /* changes due to raising max connections!*/
